...
import static com.example.android.inventory.data.PetContract.PetEntry.QUANTITY_DECREASE;
...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>, View.OnClickListener {
     ...
     * {@link PetEntry#QUANTITY_INCREASE}, {@link PetEntry#QUANTITY_DECREASE}, or
     */
    private int mGender;
    ...
    private void setupSpinner() {
        ...
        mGenderSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onNothingSelected(AdapterView<?> parent) {
                mGender = PetEntry.QUANTITY_INCREASE;
            }
        });
    }
    ...
    private void savePet() {
        ...
        if (mCurrentPetUri == null &&
                ...
                TextUtils.isEmpty(StockString) && mGender == PetEntry.QUANTITY_INCREASE) {
        ...
        values.put(PetEntry.COLUMN_STOCK, stock);
        ...
        values.put(PetEntry.COLUMN_PRODUCT_PIC, data);
